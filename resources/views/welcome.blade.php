            ...
            <div class="rounded-4 border border-1" style="background: #F6F4F3; padding: 40px">
                ...
                <div class="d-flex flex-wrap gap-3 mt-4 justify-content-center">
                    <div class="btn btn-sh w-lg-40 w-100 py-2">
                        <a href="{{$webchat_link}}">@lang('landing.sh_action_1')</a>
                    </div>
                    <div class="btn btn-sh w-lg-40 w-100 py-2">
                        <a href="{{$webchat_link}}">@lang('landing.sh_action_2')</a>
                    </div>

                    <div class="btn btn-sh w-lg-40 w-100 py-2">
                        <a href="{{$webchat_link}}">@lang('landing.sh_action_3')</a>
                    </div>
                    <div class="btn btn-sh w-lg-40 w-100 py-2">
                        <a href="{{$webchat_link}}">@lang('landing.sh_action_4')</a>
                    </div>
                </div>
            </div>
        </div>
